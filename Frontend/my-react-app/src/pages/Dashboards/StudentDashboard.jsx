...
export default function StudentDashboard() {
  ...
  const downloadReceipt = async () => {
    ...
    try {
      ...
      doc.text(`Amount Paid: ₹${receipt.amount}`, 20, 110);
          ...
          <ProCard id="fee" title="Fee Details">
            ...
            {!feeDetails ? (
              ...
              <>
                ...
                <p><strong>Fee Amount:</strong> ₹{feeDetails.fee_amount}</p>
                <p><strong>Fine (per day):</strong> ₹{feeDetails.fine}</p>
                <p><strong>Total Payable:</strong> ₹{feeDetails.total_payable}</p>
          ...
          <ProCard title="Recent Notices">
            <ul className="list-group">
              <li className="list-group-item">
                Welcome to the hostel portal — keep your documents updated.
              </li>
              <li className="list-group-item">
                Mess schedule updated for the next week.
              </li>
              <li className="list-group-item">
                Fee payment deadline approaching soon — avoid fines.
              </li>
            </ul>
          </ProCard>
        </div>
